const quotes = [
  ...
  { quote: "치킨을 먹는 것은 천국을 살짝 엿보는 것이다.", recommend: "33" },
  { quote: "인생은 치킨의 연속이다.", recommend: "44" },
  { quote: "너희는 먼저 그 다리와 날개를 구하라.", recommend: "55" },
  { quote: "인생은 B와 D사이의 C이다.Birth Chicken Death", recommend: "66" },
  {
    quote: "치킨을 단 한 번도 안먹은 사람은 있어도 한 번만 먹어본 사람은 없다.",
    recommend: "77",
  },
  { quote: "웬만한 슬픔은 치킨으로 승화된다.", recommend: "88" },
];
